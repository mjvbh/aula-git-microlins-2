...
class FamilyTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'ChurchCRM.Map.FamilyTableMap';
     ...
     */
    const OM_CLASS = '\\ChurchCRM\\Family';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'ChurchCRM.Family';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\ChurchCRM\\Family');
        ...
        $this->addColumn('fam_SendNewsLetter', 'SendNewsletter', 'BOOLEAN', true, 1, false);
  ...
  array (
    ...
    {
        return array(
            'validate' => array('rule1' => array ('column' => 'fam_name','validator' => 'NotNull',), 'rule2' => array ('column' => 'fam_name','validator' => 'Length','options' => array ('max' => 50,),), ),
        );
    } // getBehaviors()
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \ChurchCRM\Family) { // it's a model object
