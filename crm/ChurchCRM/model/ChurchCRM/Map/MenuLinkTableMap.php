...
class MenuLinkTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'ChurchCRM.Map.MenuLinkTableMap';
     ...
     */
    const OM_CLASS = '\\ChurchCRM\\MenuLink';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'ChurchCRM.MenuLink';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\ChurchCRM\\MenuLink');
    ...
    {
        return array(
            'validate' => array('rule1' => array ('column' => 'linkname','validator' => 'NotNull',), 'rule2' => array ('column' => 'linkname','validator' => 'Length','options' => array ('max' => 50,),), 'rule3' => array ('column' => 'linkuri','validator' => 'NotNull',), 'rule4' => array ('column' => 'linkuri','validator' => 'Length','options' => array ('max' => 50,),), ),
        );
    } // getBehaviors()
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \ChurchCRM\MenuLink) { // it's a model object
