...
abstract class Family implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\ChurchCRM\\Map\\FamilyTableMap';
    ...
    /**
     * Initializes internal state of ChurchCRM\Base\Family object.
     * @see applyDefaults()
     */
    ...
    /**
     * Sets the value of the [fam_sendnewsletter] column.
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $this->fam_sendnewsletter = (null !== $col) ? (boolean) $col : null;
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\ChurchCRM\\Family'), 0, $e);
        }
    }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'fam_SendNewsLetter':
                        $stmt->bindValue($identifier, (int) $this->fam_sendnewsletter, PDO::PARAM_INT);
                        break;
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\ChurchCRM\Family The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \ChurchCRM\Family (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \ChurchCRM\Family Clone of current object.
     * @throws PropelException
     */
    ...
    static public function loadValidatorMetadata(ClassMetadata $metadata)
    {
        ...
        $metadata->addPropertyConstraint('fam_name', new Length(array ('max' => 50,)));
    }
